...
data:
  ...
  bundledCode: "#line 1 \"test/DPL_5_I.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/5/DPL_5_I\"\
    ...
    */\nmint stirling_number_second(int n, int k){\n    combination C(k+1);\n    mint\
    ...
    \        res += ((k-i) & 1) ? -x:x;\n    }\n    res *= C.ifact[k];\n    return\
    \ res;\n}\n\n\n#line 6 \"test/DPL_5_I.test.cpp\"\n\n/*\n@title \u7389\u533A\u5225\
    \u3059\u308B\u3001\u7BB1\u533A\u5225\u3057\u306A\u3044\u30011\u500B\u4EE5\u4E0A\
    (\u7B2C\u4E8C\u7A2E\u30B9\u30BF\u30FC\u30EA\u30F3\u30B0\u6570)\n@category \u5199\
    \u50CF12\u76F8\n*/\nint main(){\n    int n, k;\n    cin >> n >> k;\n    cout <<\
    \ stirling_number_second(n, k) << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/DPL_5_I.test.cpp
layout: document
redirect_from:
- /verify/test/DPL_5_I.test.cpp
- /verify/test/DPL_5_I.test.cpp.html
title: "\u7389\u533A\u5225\u3059\u308B\u3001\u7BB1\u533A\u5225\u3057\u306A\u3044\u3001\
  1\u500B\u4EE5\u4E0A(\u7B2C\u4E8C\u7A2E\u30B9\u30BF\u30FC\u30EA\u30F3\u30B0\u6570\
  )"
---
